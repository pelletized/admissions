...
function twentyten_posted_on() {
	printf( __( 'BY: %2$s &nbsp;&nbsp; %1$s', 'twentyten' ),				
...
if ( ! function_exists( 'twentyten_posted_on_homepage' ) ) :
function twentyten_posted_on_homepage() {		
		printf( __( '<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
			get_author_posts_url( get_the_author_meta( 'ID' ) ),
			esc_attr( sprintf( __( 'View all posts by %s', 'twentyten' ), get_the_author() ) ),
			get_the_author()
		)
...
if ( ! function_exists( 'twentyten_homepage_post_meta' ) ) :
function twentyten_homepage_post_meta() {		
	printf( __( 'where am i', 'twentyten' ) );	
}
endif;
...
//custom style archive list


//limit how many characters in excerpt
...
//insert images default link value is none
update_option('image_default_link_type','none');

//add blockquote to tinymce

//add and save custom field on user profile pages
function my_show_extra_profile_fields( $user ) { ?>
	...
	<table class="form-table">
		<tr>
			<th><label for="twitter">Facebook Profile</label></th>
			<td>
				<input type="text" name="facebook" id="facebook" value="<?php echo esc_attr( get_the_author_meta( 'facebook', $user->ID ) ); ?>" class="regular-text" /><p><span class="description">Please enter your Facebook profile.</span></p>
			</td>
		</tr>
		<tr>
			<th><label for="twitter">Twitter Profile</label></th>
			<td>
				<input type="text" name="twitter" id="twitter" value="<?php echo esc_attr( get_the_author_meta( 'twitter', $user->ID ) ); ?>" class="regular-text" /><p><span class="description">Please enter your Twitter @name.</span></p>
			</td>
		</tr>
		<?php if ( function_exists('wp_editor') && current_user_can('publish_posts') ): ?>
		<script type="text/javascript">
		/*
		(function($){ 
			// Remove the textarea before displaying visual editor
			$('#extraprofile').parents('tr').remove();
		})(jQuery);
		*/
		</script>
		
		<tr>
			<th><label for="extraprofile">Additional Information</label></th>
			<td>
				<?php
				//$extraProfile = esc_attr( get_the_author_meta( 'extraprofile', $user->ID ) );
				//wp_editor( $extraProfile, 'extraprofile' ); 
				?>
				
				<textarea name="extraprofile" id="extraprofile" class="regular-text"><?php echo esc_attr( get_the_author_meta( 'extraprofile', $user->ID ) ); ?></textarea>			
				
				<p><span class="description">Please enter your additional information that will be displayed.</span></p>
			</td>
		</tr>
		<?php endif; ?>
	</table>
...
function my_save_extra_profile_fields( $user_id ) {
	...
	update_usermeta( $user_id, 'extraprofile', $_POST['extraprofile'] );
}
